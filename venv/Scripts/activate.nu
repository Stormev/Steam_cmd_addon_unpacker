...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Documents\MyProjects\cmd_steammod_unpack\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\Documents\MyProjects\cmd_steammod_unpack\venv\Scripts\deactivate.nu'
